...
create procedure sp_agregar_mesa(
in p_capacidad int,
...
create procedure sp_buscar_mesa(
in p_numero_mesa int
)
begin
select *
...
create procedure sp_mostrar_mesas()
begin
select * from Mesa;
end $$
...
call sp_agregar_mesa(2,'DISPONIBLE');
call sp_agregar_mesa(4,'OCUPADA');
call sp_agregar_mesa(6,'RESERVADA');
call sp_agregar_mesa(8,'DISPONIBLE');
call sp_agregar_mesa(4,'OCUPADA');
call sp_agregar_mesa(2,'RESERVADA');
call sp_agregar_mesa(6,'DISPONIBLE');
call sp_agregar_mesa(8,'OCUPADA');
call sp_agregar_mesa(10,'RESERVADA');
call sp_agregar_mesa(12,'DISPONIBLE');

-- ==========================================
-- procedimientos almacenados tabla empleados
-- ==========================================
...
call sp_agregar_reserva('2025-01-01','12:00:00',2,1,1,1);
call sp_agregar_reserva('2025-01-02','13:00:00',4,2,2,2);
call sp_agregar_reserva('2025-01-03','14:00:00',3,3,3,3);
call sp_agregar_reserva('2025-01-04','15:00:00',5,4,4,4);
call sp_agregar_reserva('2025-01-05','16:00:00',2,5,5,5);
call sp_agregar_reserva('2025-01-06','17:00:00',6,6,6,6);
call sp_agregar_reserva('2025-01-07','18:00:00',4,7,7,7);
call sp_agregar_reserva('2025-01-08','19:00:00',8,8,8,8);
call sp_agregar_reserva('2025-01-09','20:00:00',3,9,9,9);
call sp_agregar_reserva('2025-01-10','21:00:00',10,10,10,10);

-- ==========================================
-- procedimientos almacenados tabla CategoriaPlatillo
-- ==========================================
...
begin
update CategoriaPlatillo
set categoria_platillo = p_categoria
...
-- datos categoria platillo

call sp_agregar_categoria(1,'ENTRADA');
call sp_agregar_categoria(2,'SOPA Y ENSALDA');
call sp_agregar_categoria(3,'BEBIDAS');
call sp_agregar_categoria(4,'PLATO FUERTE');
call sp_agregar_categoria(5,'ACOMPAÑAMIENTOS');
call sp_agregar_categoria(6,'ENTRADA');
call sp_agregar_categoria(7,'BEBIDAS');
call sp_agregar_categoria(8,'PLATO FUERTE');
call sp_agregar_categoria(9,'ACOMPAÑAMIENTOS');
call sp_agregar_categoria(10,'SOPA Y ENSALDA');

-- ==========================================
-- procedimientos almacenados tabla platillo
-- ==========================================

delimiter $$

create procedure sp_agregar_platillo(
in p_id_platillo int,
in p_nombre_platillo varchar(50),
...
create procedure sp_actualizar_platillo(
in p_id_platillo int,
in p_nombre_platillo varchar(50),
in p_descripcion varchar(80),
in p_precio decimal(5,2),
...
begin
update Platillo
set nombre_platillo = p_nombre_platillo,
...
create procedure sp_eliminar_platillo(
in p_id_platillo int
)
begin
...
create procedure sp_buscar_platillo(
in p_id_platillo int
)
begin
select *
...
create procedure sp_mostrar_platillos()
begin
...
call sp_agregar_platillo(1,'Nachos','Nachos con queso',25.00,1);
call sp_agregar_platillo(2,'Sopa de pollo','Sopa tradicional',20.00,2);
call sp_agregar_platillo(3,'Limonada','Bebida natural',10.00,3);
call sp_agregar_platillo(4,'Carne asada','Carne con guarnicion',60.00,4);
call sp_agregar_platillo(5,'Papas fritas','Papas crujientes',15.00,5);
call sp_agregar_platillo(6,'Ensalada verde','Vegetales frescos',18.00,2);
call sp_agregar_platillo(7,'Hamburguesa especial','Doble carne',45.00,4);
call sp_agregar_platillo(8,'Jugo de naranja','Natural',12.00,3);
call sp_agregar_platillo(9,'Aros de cebolla','Entrada especial',16.00,1);
call sp_agregar_platillo(10,'Arroz','Acompañamiento',8.00,5);
...
create procedure sp_buscar_detalle_pedido(
in p_id_detalle_pedido int
)
begin
select *
...
create procedure sp_mostrar_detalle_pedidos()
begin
...
call sp_agregar_detalle_pedido(1,2,50.00,1,1);
call sp_agregar_detalle_pedido(2,1,20.00,2,2);
call sp_agregar_detalle_pedido(3,3,30.00,3,3);
call sp_agregar_detalle_pedido(4,1,60.00,4,4);
call sp_agregar_detalle_pedido(5,2,30.00,5,5);
call sp_agregar_detalle_pedido(6,1,18.00,6,6);
call sp_agregar_detalle_pedido(7,2,90.00,7,7);
call sp_agregar_detalle_pedido(8,3,36.00,8,8);
call sp_agregar_detalle_pedido(9,2,32.00,9,9);
call sp_agregar_detalle_pedido(10,4,32.00,10,10);
...
call sp_agregar_factura('2025-03-01',50.00,0.12,56.00,1,1,1);
call sp_agregar_factura('2025-03-02',20.00,0.12,22.40,2,2,2);
call sp_agregar_factura('2025-03-03',30.00,0.12,33.60,3,3,3);
call sp_agregar_factura('2025-03-04',60.00,0.12,67.20,4,4,4);
call sp_agregar_factura('2025-03-05',30.00,0.12,33.60,5,5,5);
call sp_agregar_factura('2025-03-06',18.00,0.12,20.16,6,6,6);
call sp_agregar_factura('2025-03-07',90.00,0.12,100.80,7,7,7);
call sp_agregar_factura('2025-03-08',36.00,0.12,40.32,8,8,8);
call sp_agregar_factura('2025-03-09',32.00,0.12,35.84,9,9,9);
call sp_agregar_factura('2025-03-10',32.00,0.12,35.84,10,10,10);
...
create procedure sp_mostrar_pagos()
begin
select * from Pago;
end $$
...
call sp_agregar_pago('EFECTIVO',56.00,'2025-04-01',1,1);
call sp_agregar_pago('TARJETA',22.40,'2025-04-02',2,2);
call sp_agregar_pago('TRANSFERENCIA',33.60,'2025-04-03',3,3);
call sp_agregar_pago('EFECTIVO',67.20,'2025-04-04',4,4);
call sp_agregar_pago('TARJETA',33.60,'2025-04-05',5,5);
call sp_agregar_pago('TRANSFERENCIA',20.16,'2025-04-06',6,6);
call sp_agregar_pago('EFECTIVO',100.80,'2025-04-07',7,7);
call sp_agregar_pago('TARJETA',40.32,'2025-04-08',8,8);
call sp_agregar_pago('TRANSFERENCIA',35.84,'2025-04-09',9,9);
call sp_agregar_pago('EFECTIVO',35.84,'2025-04-10',10,10);
